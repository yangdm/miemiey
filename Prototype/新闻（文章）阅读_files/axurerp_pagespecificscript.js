...
var PageName = '新闻（文章）阅读';
var PageId = 'b591264cbf51438e9e212f811d7eaa0d'
var PageUrl = '新闻（文章）阅读.html'
document.title = '新闻（文章）阅读';
var PageNotes = 
{
"pageName":"新闻（文章）阅读",
...
{
"label":"?",
"描述":"对http:\/\/portal.miemiey.com\/protal.php?mod=view&amp;aid=131&amp;page=1进行改造，增加参数sid ,判断sid非空时按这个模板输出"};
