...
var PageName = '学校概况';
var PageId = '126639e3995b4f59a9203ec91980e5f9'
var PageUrl = '学校概况.html'
document.title = '学校概况';
var PageNotes = 
{
"pageName":"学校概况",
"showNotesNames":"False",
"关闭":"<p style=\"text-align:left;\"><span style=\"\">学校概况显示和该机构相关的文章<\/span><\/p><p style=\"text-align:left;\"><span style=\"\">左边为文章分类，在学校下只需支持一级<\/span><\/p>"}
var $OnLoadVariable = '';
...
{
"label":"?",
"描述":"对http:\/\/www.miemiey.com\/portal.php?mod=list&amp;catid=8进行改造，增加参数sid ,判断sid非空时按这个模板输出"};
...
if (true) {
	...
	self.location.href="新闻（文章）阅读.html" + GetQuerystring();
